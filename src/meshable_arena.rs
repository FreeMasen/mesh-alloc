...
use crate::{cheap_heap::CheapHeap, common};
...
//   CheapHeap<kMiniHeapSize, kArenaSize / kPageSize> _mhAllocator{};
    _mh_allocator: CheapHeap<{common::MINI_HEAP_SIZE}, { common::arena_size() / common::PAGE_SIZE }>,
//   MWC _fastPrng;
    pub(crate) _fast_prng: rand::rngs::SmallRng,
